...
prompt = f"Here are some specifics about a story I am writing. Considering ALL information given, write a detailed outline with 5 bullet points. Do this by writing the bullet points, with a # before each, then expand on any topics covered in that section, organized into categories: {points_for_each_section}\n"
